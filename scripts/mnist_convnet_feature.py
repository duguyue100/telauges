...
train_output_feature=theano.function(inputs=[index],
                                    outputs=layer_2.get_output(layer_1.get_output(layer_0.get_output(X.reshape((batch_size, 1, 28, 28)))).flatten(2)),
                                    givens={X: train_set_x[index * batch_size: (index + 1) * batch_size]});
...
pickle.dump(train_feature, open("mnist_train_convnet_feature_200_ordered.pkl", "w"));
pickle.dump(train_feature_random, open("minst_train_convnet_feature_200_random.pkl", "w"));
...
pickle.dump(test_feature, open("mnist_test_convnet_feature_200_ordered.pkl", "w"));
pickle.dump(test_feature_random, open("mnist_test_convnet_feature_200_random.pkl", "w"));
