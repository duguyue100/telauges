...
@note: CIFAR-100 convnet feature 
"""
...
pickle.dump(train_feature, open("cifar100_train_convnet_feature_500_sub_ordered.pkl", "w"));
pickle.dump(train_feature_random, open("cifar100_train_convnet_feature_500_sub_random.pkl", "w"));
...
pickle.dump(test_feature, open("cifar100_test_convnet_feature_500_sub_ordered.pkl", "w"));
pickle.dump(test_feature_random, open("cifar100_test_convnet_feature_500_sub_random.pkl", "w"));
